...
model = dict(roi_head=dict(bbox_head=[dict(type='Shared2FCBBoxHead',num_classes=11),dict(type='Shared2FCBBoxHead',num_classes=11),dict(type='Shared2FCBBoxHead',num_classes=11)]))
# dataset settings
